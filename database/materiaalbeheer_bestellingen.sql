...
CREATE TABLE `bestellingen` (
  ...
  `technieker_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKgmu7chdlatkbxou87ueskisxl` (`technieker_id`),
  CONSTRAINT `FKgmu7chdlatkbxou87ueskisxl` FOREIGN KEY (`technieker_id`) REFERENCES `gebruikers` (`id`)
